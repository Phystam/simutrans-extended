...
{
	bool rail_track = (sch->get_desc()->get_wtyp() == monorail_wt || sch->get_desc()->get_wtyp() == maglev_wt || sch->get_desc()->get_wtyp() == tram_wt || sch->get_desc()->get_wtyp() == narrowgauge_wt || sch->get_desc()->get_wtyp() == narrowgauge_tram_wt) && sch->get_desc()->get_wtyp() != air_wt;
